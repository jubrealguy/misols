                ...
                <div class="row">
                    ...
                    <div class="col-1-of-2">
                        <div class="composition">
                            <img src={about1} alt="about-photo1" class="composition__photo composition__photo--p1" />
                            <img src={about2}  alt="about-photo2" class="composition__photo composition__photo--p2" />
                            <img src={about3}  alt="about-photo3" class="composition__photo composition__photo--p3" />
                        </div>
                    </div>
                </div>
            </section>
